    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-y-10 sm:gap-y-12 gap-x-4 sm:gap-x-6 lg:gap-x-8">
            ...
            <a href="{{ route('jadwal.dokter') }}?spesialis=Jantung" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            ...
                            <linearGradient id="grad-aorta" x1="0%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stop-color="#38bdf8" />
                                <stop offset="100%" stop-color="#0284c7" />
                            </linearGradient>
                        </defs>
                        <path d="M26 12V6c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2v6" fill="url(#grad-aorta)" stroke="#0284c7" stroke-width="1.8" stroke-linecap="round"/>
                        <path d="M37 14V8c0-1.1.9-2 2-2h3c1.1 0 2 .9 2 2v8" fill="url(#grad-aorta)" stroke="#0284c7" stroke-width="1.8" stroke-linecap="round"/>
                        <path d="M32 54C18 43 8 32 8 20a12 12 0 0 1 21.2-7.8L32 15l2.8-2.8A12 12 0 0 1 56 20c0 12-10 23-24 34z" fill="url(#grad-heart)" stroke="#b91c1c" stroke-width="2"/>
            ...
            <a href="{{ route('jadwal.dokter') }}?spesialis=Anak" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            <linearGradient id="grad-steth" x1="0%" y1="0%" x2="100%" y2="100%">
                        ...
                        <path d="M19 37c3.5 3 8 4.5 13 4.5s9.5-1.5 13-4.5" stroke="url(#grad-steth)" stroke-width="3" stroke-linecap="round"/>
                        <path d="M20 37v9c0 6 5 10 12 10s12-4 12-10v-9" stroke="url(#grad-steth)" stroke-width="2" stroke-linecap="round"/>
                ...
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            ...
                            <linearGradient id="grad-eyeball" x1="0%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stop-color="#ffffff" />
                                <stop offset="100%" stop-color="#e0f2fe" />
                            </linearGradient>
                        </defs>
                        <path d="M6 32S16 14 32 14s26 18 26 18-10 18-26 18S6 32 6 32z" fill="url(#grad-eyeball)" stroke="#0284c7" stroke-width="2.2" stroke-linejoin="round"/>
                        <circle cx="32" cy="32" r="10" fill="url(#grad-iris)" stroke="#0369a1" stroke-width="1.5"/>
            ...
            <a href="{{ route('jadwal.dokter') }}?spesialis=Bedah" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            <linearGradient id="grad-ribs" x1="0%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stop-color="#64748b" />
                                <stop offset="100%" stop-color="#334155" />
                            </linearGradient>
                            <linearGradient id="grad-thor-heart" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stop-color="#f87171" />
                                <stop offset="100%" stop-color="#dc2626" />
                            </linearGradient>
                        </defs>
                        <path d="M32 38c-5-4-9-8-9-13a5 5 0 0 1 9-3 5 5 0 0 1 9 3c0 5-4 9-9 13z" fill="url(#grad-thor-heart)" stroke="#b91c1c" stroke-width="1.5"/>
                        ...
                        <path d="M32 15c-7-3-15-1-19 4M32 15c7-3 15-1 19 4" stroke="url(#grad-ribs)" stroke-width="2.4" stroke-linecap="round"/>
                        <path d="M32 24c-9-3-18 0-22 6M32 24c9-3 18 0 22 6" stroke="url(#grad-ribs)" stroke-width="2.4" stroke-linecap="round"/>
                        <path d="M32 33c-10-2-20 2-23 9M32 33c10-2 20 2 23 9" stroke="url(#grad-ribs)" stroke-width="2.4" stroke-linecap="round"/>
                        <path d="M32 42c-9 0-18 4-20 10M32 42c9 0 18 4 20 10" stroke="url(#grad-ribs)" stroke-width="2.4" stroke-linecap="round"/>
                    </svg>
                    <span class="absolute top-1 right-1 w-2.5 h-2.5 rounded-full bg-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-xs"></span>
                </div>
                <span class="text-xs sm:text-sm font-bold text-[#0e7c47] group-hover:text-amber-600 transition-colors leading-snug">
            ...
            <a href="{{ route('jadwal.dokter') }}?spesialis=Paru" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            <linearGradient id="grad-lung-l" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stop-color="#6ee7b7" />
                                <stop offset="100%" stop-color="#059669" />
                            </linearGradient>
                            <linearGradient id="grad-lung-r" x1="100%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stop-color="#6ee7b7" />
                                <stop offset="100%" stop-color="#059669" />
                            </linearGradient>
                        </defs>
                        ...
                        <path d="M29 20c-3 1-8 4-11 1-5-5-9 6-10 16-1 9 5 18 13 18 6 0 8-7 8-15v-20z" fill="url(#grad-lung-l)" stroke="#047857" stroke-width="2"/>
                        <path d="M35 20c3 1 8 4 11 1 5-5 9 6 10 16 1 9-5 18-13 18-6 0-8-7-8-15v-20z" fill="url(#grad-lung-r)" stroke="#047857" stroke-width="2"/>
            ...
            <a href="{{ route('jadwal.dokter') }}?spesialis=Bedah" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                    <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                        <defs>
                            <linearGradient id="grad-scalpel-b" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stop-color="#f8fafc" />
                                <stop offset="100%" stop-color="#94a3b8" />
                            </linearGradient>
                            <linearGradient id="grad-scalpel-h" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stop-color="#34d399" />
                                <stop offset="100%" stop-color="#059669" />
                            </linearGradient>
                        </defs>
                        <path d="M49 13l2 2c2 2 1 5-1 7L30 42l-14 4 4-14L40 12c2-2 5-3 7-1z" fill="url(#grad-scalpel-h)" stroke="#047857" stroke-width="2"/>
                        <path d="M40 12l9 1c2 2 1 5-1 7l-8-8z" fill="url(#grad-scalpel-b)" stroke="#64748b" stroke-width="1.5"/>
        ...
        <div x-show="showAllSpesialis" 
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-y-10 sm:gap-y-12 gap-x-4 sm:gap-x-6 lg:gap-x-8">
                ...
                <a href="{{ route('jadwal.dokter') }}?spesialis=Penyakit+Dalam" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                        <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                            ...
                            <path d="M32 23v6c0 3 4 3 6 5 3 3 2 8-2 10-5 2-9-1-9-6 0-4 3-6 6-6" fill="url(#grad-stomach)" stroke="#c2410c" stroke-width="2"/>
                ...
                <a href="{{ route('jadwal.dokter') }}?spesialis=Saraf" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                        <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                            ...
                            <path d="M32 12c-5-5-17-4-21 4-4 7-2 16 2 20-2 4-2 9 1 12 4 4 10 3 13 1 2 4 8 6 13 2" fill="url(#grad-brain)" stroke="#6d28d9" stroke-width="2"/>
                            <path d="M32 12c5-5 17-4 21 4 4 7 2 16-2 20 2 4 2 9-1 12-4 4-10 3-13 1-2 4-8 6-13 2" fill="url(#grad-brain)" stroke="#6d28d9" stroke-width="2"/>
                ...
                <!-- 10. Psikiatri -->
                <a href="{{ route('jadwal.dokter') }}?spesialis=Psikiatri" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                        <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                            <defs>
                                <linearGradient id="grad-mind" x1="0%" y1="0%" x2="100%" y2="100%">
                            ...
                            <circle cx="36" cy="27" r="7" fill="url(#grad-mind)" stroke="#d97706" stroke-width="1.8"/>
                ...
                <a href="{{ route('jadwal.dokter') }}?spesialis=Gigi" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                        <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                            <defs>
                                <linearGradient id="grad-tooth" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#ffffff" />
                                    <stop offset="50%" stop-color="#e0f2fe" />
                                    <stop offset="100%" stop-color="#bae6fd" />
                                </linearGradient>
                            </defs>
                            <path d="M18 20c0-8 6-12 14-12s14 4 14 12c0 9-3 15-4 24-1 6-4 11-6 11s-2-8-2-13-2 13-4 13-5-5-6-11c-1-9-4-15-4-24z" fill="url(#grad-tooth)" stroke="#0284c7" stroke-width="2.2" stroke-linejoin="round"/>
                ...
                <a href="{{ route('jadwal.dokter') }}?spesialis=THT" class="group flex flex-col items-center text-center p-2 rounded-2xl transition-all duration-300 hover:-translate-y-1.5">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-b from-emerald-50 to-teal-50/70 border-2 border-emerald-100/90 group-hover:border-[#0e7c47] group-hover:from-emerald-100/80 group-hover:to-teal-100/80 group-hover:shadow-md group-hover:shadow-emerald-900/10 flex items-center justify-center mb-3.5 transition-all duration-300 relative">
                        <svg class="w-10 h-10 sm:w-11 sm:h-11 transition-transform duration-300 group-hover:scale-110 drop-shadow-xs" viewBox="0 0 64 64" fill="none">
                            <defs>
                                <linearGradient id="grad-ear" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#fed7aa" />
                                    <stop offset="100%" stop-color="#fb923c" />
                                </linearGradient>
                            </defs>
                            <path d="M18 18c-6 0-10 5-10 11 0 9 6 13 10 18 2 2 3 5 2 8" fill="url(#grad-ear)" stroke="#ea580c" stroke-width="2" stroke-linecap="round"/>
        ...
        <div class="mt-12 text-center">
            <button @click="showAllSpesialis = !showAllSpesialis" 
                ...
                <span x-text="showAllSpesialis ? 'Tutup' : 'Lihat Semua'">Lihat Semua</span>
            </button>
        </div>
